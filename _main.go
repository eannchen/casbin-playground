...
func main() {
	...
	fmt.Println()
	j, _ := json.Marshal(e.GetPermissionsForUserInDomain("user:ian", "dom:admin"))
	fmt.Println("GetPermissionsForUserInDomain: ", string(j))

	fmt.Println()
	j1, _ := json.Marshal(e.GetPermissionsForUserInDomain("user:ian", "dom:marketing"))
	fmt.Println("GetPermissionsForUserInDomain: ", string(j1))

	fmt.Println()
	r, _ := e.GetImplicitPermissionsForUser("user:ian", "dom:admin")
	j2, _ := json.Marshal(r)
	...
	fmt.Println()
	j4, _ := json.Marshal(e.GetAllSubjects())
	fmt.Println("GetAllSubjects: ", string(j4))

	fmt.Println()
	j5, _ := json.Marshal(e.GetAllRoles())
